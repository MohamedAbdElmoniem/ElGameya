        ...
        AsyncStorage.getItem('adminId', (err, result) => {
            ...
            axios({
                ...
                .then((resp) => {
                    ...
                    this.setState({ chatBox: ChatArray, progressVisible: false, ReceiverId: userId }, () => {
            ...
            <Container>
                ...
                <Modal backButtonClose={true} style={[styles.modal, styles.ModalMsg]} position={"center"} ref={"ModalMsg"}
                    ...
                    <Container>
                        ...
                        <ScrollView ref="scrollView" onContentSizeChange={(contentWidth, contentHeight) => {
                            this.refs.scrollView.scrollTo({ x: contentWidth, y: contentHeight, animated: true });
                        }}>
                            <Grid>
                                {this.state.chatBox}
                            </Grid>
                        ...
                        <View style={{ height: 70 }}>
                            ...
                            <Button style={{ backgroundColor: "#262261", borderRadius: 10 }} small onPress={() => {
                                this.sendMessage();
                            }}><Text style={{ color: "white" }}>send message</Text></Button>
                        </View>
                    </Container>
                </Modal>
            </Container>
